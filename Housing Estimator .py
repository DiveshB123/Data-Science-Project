...
def make_prediction(bedrooms1, bathrooms1, stories1, mainroad1,guestroom1,basement1,hotwaterheating1,airconditioning1,parking1,furnishingstatus1,prefarea1):
    ...
    domain=Domain([bedrooms,bathrooms,stories,mainroad,guestroom,basement,hotwaterheating,airconditioning,parking,furnishingstatus,prefarea])
	
	#Our data is the data being passed by the website inputs. This gets mapped to our domain, which we defined above.
    data=Table(domain,[[bedrooms1, bathrooms1, stories1, mainroad1,guestroom1,basement1,hotwaterheating1,airconditioning1,parking1,furnishingstatus1,prefarea1]])
...
Prefarea=gr.Dropdown(["yes","no"],label="Does the house have a prefarea?")
...
app = gr.Interface(fn = make_prediction, inputs=[NumberOfBedrooms, NumberOfBathrooms, NumberOfStories,OnMainRoad,HasGuestRoom,HasBasement,HasHotWaterHeating,HasAC,parkingstatus,Furnished,Prefarea], outputs=output)
app.launch()